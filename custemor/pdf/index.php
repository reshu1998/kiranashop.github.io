...
if(isset($_POST["action"]))
{
	...
	$mail->Password = 'nmkreqakoreyhdwx';					//Sets SMTP password
	$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"


	
	$mail->From = 'reshmanikam1998@gmail.com';			//Sets the From email address for the message
	$mail->FromName = 'reshma nikam';			//Sets the From name of the message
        
   
   	$mail->AddAddress('sarikaan1998@gmail.com', 'sarika');		//Adds a "To" address
