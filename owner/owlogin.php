...
{
  echo "<h1>You are alraedy login</h1>";
  exit();
}
...
<form action="" method="POST">
  <div class="container">
    <h1 class="text-white"><center><strong>Owner Login</strong></center></h1>
  ...
  <div class="container signin">
    <p class="text-dark">password not remembered? <a href="#" class="text-dark">change password</a>.</p>
  </div>
</form>
